        ...
        <div class="about-page">
            <section class="about-section light-gradient">
                <div class="about-card two-column-card">
                    ...
                    <div class="card-image">
                        <img src="images/about-apartment.png" alt="University of Idaho campus building" />
                    </div>
                </div>
            </section>
            ...
            <section class="about-section mid-gradient">
                 <div class="about-card two-column-card reverse">
                    ...
                    <div class="card-image">
                        <img src="images/about-e-club.png" alt="Founder Mason Benoit speaking" />
                    </div>
                </div>
            </section>
            ...
            <section class="about-section dark-bg">
                <div class="history-grid">
                    <div class="history-card large-card">
                        <img src="images/about-peoples-pretzel.jpg" alt="The People's Pretzel stand" />
                    ...
                    <div class="history-card small-card">
                        <img src="images/about-bmc-gallery.jpg" alt="Founder Mason Benoit" />
